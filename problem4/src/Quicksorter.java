...
/**
 * An implementation of Quicksort without the baggage of interfaces 
 * and such.  Uses DNF to partition.
 */
public class Quicksorter {
    ...
    /**
     * Sort the subarray of values from lb (inclusive) to ub (exclusive)
     * using order to compare values.
     */
    public static <T> void qsort(T[] values, Comparator<T> order,
            int lb, int ub) {
        // STUB
