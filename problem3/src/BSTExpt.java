...
public class BSTExpt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BST<String,String> dict = new BST<String,String>(new 
               Comparator<String>() {
        ...
        String[] values = new String[] { "gorilla", "dingo", "chimp", 
            "emu", "elephant", "beta", "aardark", "chinchilla", "yeti",
            "gibbon", "horse", "elephant", "duck", "emu" };
     ...
     */
    public static void iterate(PrintWriter pen, 
